  ...
  <section class="flex min-h-full flex-col">
    ...
    <main class="flex-1 min-h-0">
      ...
      <template v-else>
        ...
        <div
          v-if="booksInitialized && !loading && !lens?.filter && books.length === 0"
        ...
        <div
          v-else-if="booksInitialized && !loading && books.length === 0 && lens?.filter"
